    ...
    <div class="uk-container uk-container-large">
        <div data-uk-grid>
            ...
            <div class="uk-width-1-1 uk-width-expand@s">
                <div class="uk-child-width-1-1 uk-grid-medium" data-uk-grid data-uk-scrollspy="target: > div; cls: uk-animation-slide-bottom-small; delay: 250">
                    <?php for ($i=1; $i<10; $i++) { ?>
                        <?php include ('partials_list_row.php'); ?>
                    <?php } ?>
                </div>
            </div>
        </div>
